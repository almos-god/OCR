...
// 构造函数
QCustomImage::QCustomImage(int width, int height)
    : rect(QRectF(0, 0, width, height))
{
    ...
    // Initialize the graphics and function maps
    initializeGraphicsFunctionMap();
    initializeFunctionFunctionMap();
}

    // Implementation of initializeGraphicsFunctionMap
    void QCustomImage::initializeGraphicsFunctionMap()
    {
    ...
    // Implementation of initializeFunctionFunctionMap
    void QCustomImage::initializeFunctionFunctionMap()
    {
    ...
    void QCustomImage::set_expansion(bool expand)
    {
        this->expand=expand;
        if(this->expand==true)
    ...
    //改变功能
    void QCustomImage::changefunction(all_my_function function)
    {
    ...
    //改变图形
    void QCustomImage::changegraphics(all_my_graphics graphics)
    {
        this->graphics1=graphics;
        this->function1=func_painting;
    }
    void QCustomImage::setforegroundColor(QColor color,bool foregroundcolor)
    {
    ...
    QColor QCustomImage::getforegroundColor()
    {
        return foregroundColor;
    }
    void QCustomImage::setbackgroundColor(QColor color,bool backgroundcolor)
    {
    ...
    QColor QCustomImage::getbackgroundColr()
    {
        return backgroundColor;
    }
    void QCustomImage::setborderWidth(int width)
    {
        borderWidth = width;
    }
    void QCustomImage::setimage(QImage newimage)
    {
    ...
    // 进行缩放
    void QCustomImage::doScaling(qreal factor)
    {
    ...
    void QCustomImage::painting_basic(QGraphicsSceneMouseEvent *event,int mouse)
    {
        event->accept();
        if(mouse==1)
        {
    ...
    void QCustomImage::painting_straight_line(QGraphicsSceneMouseEvent *event,int mouse)
    {
    ...
    void QCustomImage::painting_right_circle(QGraphicsSceneMouseEvent *event, int mouse)
    {
        static QPointF startPoint;
    ...
    void QCustomImage::painting_ellipse(QGraphicsSceneMouseEvent *event, int mouse)
    {
        static QPointF startPoint;
        static QImage tempImage;
    ...
    void QCustomImage::painting_isosceles_triangle(QGraphicsSceneMouseEvent *event, int mouse)
    {
        static QPointF startPoint;
        static QImage tempImage;
    ...
    void QCustomImage::painting_right_triangle(QGraphicsSceneMouseEvent *event, int mouse)
    {
        static QPointF startPoint;
        static QImage tempImage;
    ...
    void QCustomImage::painting_right_rectangle(QGraphicsSceneMouseEvent *event, int mouse)
    {
        static QPointF startPoint;
        static QImage tempImage;
    ...
    void QCustomImage::painting_rounded_rectangle(QGraphicsSceneMouseEvent *event, int mouse)
    {
        static QPointF startPoint;
        static QImage tempImage;
    ...
    void QCustomImage::painting_diamond(QGraphicsSceneMouseEvent *event, int mouse)
    {
        static QPointF startPoint;
        static QImage tempImage;
    ...
    void QCustomImage::painting_hexagon(QGraphicsSceneMouseEvent *event, int mouse)
    {
        static QPointF startPoint;
        static QImage tempImage;
    ...
    void QCustomImage::painting_four_pointed_star(QGraphicsSceneMouseEvent *event, int mouse)
    {
        static QPointF startPoint;
        static QImage tempImage;
    ...
    void QCustomImage::painting_five_pointed_star(QGraphicsSceneMouseEvent *event, int mouse)
    {
        static QPointF startPoint;
        static QImage tempImage;
    ...
    void QCustomImage::painting_six_pointed_star(QGraphicsSceneMouseEvent *event, int mouse)
    {
        static QPointF startPoint;
        static QImage tempImage;
...
*/
    void QCustomImage::painting_lightning(QGraphicsSceneMouseEvent *event, int mouse)
    {
        static QPointF startPoint;
        static QImage tempImage;
    ...
    void QCustomImage::painting_left(QGraphicsSceneMouseEvent *event, int mouse)
    {
        static QPointF startPoint;
        static QImage tempImage;
    ...
    void QCustomImage::painting_right(QGraphicsSceneMouseEvent *event, int mouse)
    {
        static QPointF startPoint;
        static QImage tempImage;
    ...
    void QCustomImage::painting_top(QGraphicsSceneMouseEvent *event, int mouse)
    {
        static QPointF startPoint;
        static QImage tempImage;
    ...
    void QCustomImage::painting_bottom(QGraphicsSceneMouseEvent *event, int mouse)
    {
        static QPointF startPoint;
        static QImage tempImage;
    ...
    void QCustomImage::painting_rounded_rectangle_annotation(QGraphicsSceneMouseEvent *event, int mouse)
    {
        static QPointF startPoint;
        static QImage tempImage;
    ...
    void QCustomImage::painting_cloud_annotation(QGraphicsSceneMouseEvent *event, int mouse)
    {
        static QPointF startPoint;
        static QImage tempImage;
    ...
    void  QCustomImage::printing_circle_annotation(QGraphicsSceneMouseEvent *event, int mouse)
    {
        static QPointF startPoint;
        static QImage tempImage;
    ...
    void QCustomImage::color_extractor(QGraphicsSceneMouseEvent *event, int mouse) {
        if (mouse == 1||mouse==2) {
    ...
    void QCustomImage::my_erase(QGraphicsSceneMouseEvent *event, int mouse)
    {
    ...
    void QCustomImage::fill(QGraphicsSceneMouseEvent *event, int mouse)
    {
        if (mouse == 1||mouse==2)
        {
    ...
    void QCustomImage::crop(QGraphicsSceneMouseEvent *event,int mouse)
    {
        if(mouse==1)
        {
            QPointF k=event->pos();
    ...
    void QCustomImage::right_rotation()
    {
        // 创建一个 45 度的旋转变换
    ...
    void QCustomImage::left_rotation()
    {
        // 创建一个 -90 度的旋转变换（左旋转）
        QTransform transform;
        transform.rotate(-90);
    ...
    void QCustomImage::flip_vertically()
    {
        // 创建一个垂直翻转的变换
        QTransform transform;
    ...
    void QCustomImage::flip_horizontally()
    {
        // 创建一个水平翻转的变换
        QTransform transform;
    ...
    void QCustomImage::choice_painting(QGraphicsSceneMouseEvent *event,int mouse)
    {
    ...
    void QCustomImage::choice_function(QGraphicsSceneMouseEvent *event,int mouse)
    {
    ...
    // 修改图像的大小
    void QCustomImage::changeImageSize(int newWidth, int newHeight)
    {
    ...
    void QCustomImage::drawPoint(QPointF point, QColor color, int diameter)
    {
        if (originalImage.isNull())
            return; // 确保图像有效
        QPen pen(color);
    ...
    void QCustomImage::drawLine(QPointF startPoint, QPointF endPoint, QColor color, int width)
    {
        if (originalImage.isNull())
            return; // 确保图像有效
    ...
    void QCustomImage::setGeometry(int x, int y)
    {
        // 修改图像的位置和大小
    ...
    int QCustomImage::getwidth()
    {
        return width;
    }
    int QCustomImage::getheight()
    {
        return height;
    }
    QImage QCustomImage::getImage() const
    {
        return originalImage;
    }
    QPainterPath QCustomImage::shape() const {
        QPainterPath path;
    ...
    QRectF QCustomImage::boundingRect() const {
        // 合并现有图片区域和动态调整后的边界区域
    ...
    void QCustomImage::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)  {
        Q_UNUSED(option);
        Q_UNUSED(widget);
    ...
    bool QCustomImage::isPointNearLine(const QPointF &point, const QLineF &line, qreal threshold) const {
        return QLineF(point, line.p1()).length() + QLineF(point, line.p2()).length()
        - line.length() < threshold;
    }

    void QCustomImage::mousePressEvent(QGraphicsSceneMouseEvent *event)
    {
    ...
    void QCustomImage::mouseMoveEvent(QGraphicsSceneMouseEvent *event)
    {
    ...
    void QCustomImage::mouseReleaseEvent(QGraphicsSceneMouseEvent *event) {
